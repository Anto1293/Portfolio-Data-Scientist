...
| 💰️ Implémentation d'un modèle de scoring client | Modèle de classification automatique et déploiement du modèle sélectionné | Python, Mlflow, Git/Github, API, Streamlit et Render| Accès au repository [https://projet-7-scoring-credit-interface.onrender.com]|
| 🔎 Réalisez un dashboard et assurez une veille technique | Amélioration de l'interface Streamlit avec accessibilité WCAG [https://projet-7-interface-version2.onrender.com] | Réalisation d'une veille technique en NLP, test du modèle sélectionne (Flan-T5) et note méthodologique []
...
- **Langages** : Python (avancé), SQL (maîtrise), R (intermédiaire en cours)
- **Data Science** : Analyse exploratoire, Feature Engineering, Machine Learning supervisé et non-supervisé, data visualisation
- **Deep Learning** : Classification d’images (CNN), classification de textes (NLP), architecture Transformer
- **Big Data** (en cours) : Hadoop, Spark
- **Cloud** (en cours) : AWS, Azure, Render, Databricks
- **Outils** : Jupyter, Git, GitHub, VSCode, Streamlit, Mlflow
